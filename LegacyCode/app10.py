...
MODEL_INFO = {
    'Llama-3.2-3B-Instruct': {
        'id': 'meta-llama/Llama-3.2-3B-Instruct',  # Adjust this to the correct model ID
        'type': 'text',  # Indicates text model
    },
    'Llama3.2-11B-Vision-Instruct': {
        'id': 'meta-llama/Llama-3.2-11B-Vision-Instruct',  # Replace with the correct model ID or path
...
def generate_memory_addendum("The user has submitted a message; please read it, and the contents of the memory bank, then generate a summary of information that should be retained from the user's input and the memory bank contents combined. Note that this summary will become the memory bank contents next time the user submits a message."):
    ...
    MEMORY_MODEL_ID = 'meta-llama-3.2-3B-instruct' MODEL_INFO[MEMORY_MODEL_NAME]['meta-llama/Llama-3.2-3B-instruct']
