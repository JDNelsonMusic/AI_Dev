...
# Model IDs (Using Hugging Face model IDs)
MODEL_IDS = {
...
def generate_memory_addendum(message):
    # For simplicity, we'll just return an empty addendum
    return ""
...
def generate_response(message, max_length=512, model_name='Llama-3.2-3B-Instruct'):
...
def index():
    ...
    if request.method == 'POST':
        ...
        return render_template(
            ...
            models_available=list(MODEL_IDS.keys()),
